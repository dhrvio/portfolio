...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="py-1">
      <div className="py-14 px-6 md:px-20 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative z-10 bg-black rounded-4xl border border-zinc-100 my-40">
        {/* Left Column */}
